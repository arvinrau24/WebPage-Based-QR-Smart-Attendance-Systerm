...
if BREVO_API_KEY:
    ...
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'smartattendance.utem@gmail.com')
else:
    ...
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'smartattendance.utem@gmail.com')
if not DEBUG:
